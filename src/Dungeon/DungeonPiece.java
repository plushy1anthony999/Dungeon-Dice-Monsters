...
public abstract class DungeonPiece {
	...
	protected final int[] centerCoordinates; // The space that a monster will start on when summoning a monster
	...
	public DungeonPiece(Color color, int[] centerCoordinates) {
		COLOR = color;
		this.centerCoordinates = centerCoordinates;
	}
	
	public Color getColor() { return COLOR; }
	public int[] getCenterCoordinates() { return centerCoordinates; }
